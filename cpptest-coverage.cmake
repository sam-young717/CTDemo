...
function (cpptest_enable_coverage)
  ...
  execute_process(COMMAND ${CMAKE_COMMAND}
                          /opt/Parasoft/cpptest-ct/runtime/
                          "-G${CMAKE_GENERATOR}"
  ...
  set(CPPTEST_CPPTESTCC /mnt/c/Users/syoung/Documents/CppTestLinux/cpptest-ct/bin/cpptestcc)
  ...
  add_custom_target(cpptestcov-compute
    ...
    &&
    /mnt/c/Users/syoung/Documents/CppTestLinux/cpptest-ct/bin/cpptestcov compute
    ...
    &&
    /mnt/c/Users/syoung/Documents/CppTestLinux/cpptest-ct/bin/cpptestcov index
  ...
  add_custom_target(cpptestcov-report
    COMMAND
    /mnt/c/Users/syoung/Documents/CppTestLinux/cpptest-ct/bin/cpptestcov report html
        ...
        "${CPPTEST_SOURCE_DIR}/.coverage"
    &&
    /mnt/c/Users/syoung/Documents/CppTestLinux/cpptest-ct/bin/cpptestcov report text
        -root ${CPPTEST_SOURCE_DIR}
        -coverage ${CPPTEST_COVERAGE_TYPE_REPORT}
        "${CPPTEST_SOURCE_DIR}/.coverage"
    &&
    /mnt/c/Users/syoung/Documents/CppTestLinux/cpptest-ct/bin/cpptestcov report mcdc
        "${CPPTEST_SOURCE_DIR}/.coverage"
  )
  ...
  add_custom_target(cpptestcov-suppress
    COMMAND
    /mnt/c/Users/syoung/Documents/CppTestLinux/cpptest-ct/bin/cpptestcov suppress
        "${CPPTEST_SOURCE_DIR}/.coverage"
  )
